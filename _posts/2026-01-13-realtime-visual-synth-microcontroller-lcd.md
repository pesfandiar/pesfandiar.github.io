...
You can find the source code in [this standalone repo](https://github.com/pesfandiar/PicoLcdGenerativeArt) or in my [collection of Pico projects](https://github.com/pesfandiar/PicoProjects/tree/main/projects/pico_lcd_generative_art). The LCD vendor provides a C SDK shared between multiple products. I extracted the part specific to my display and changed it to use a 240x240 frame buffer for rendering, before sending every frame to the display.
